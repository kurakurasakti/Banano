...
// ===========================================function===================================================
  ...
  onBtnAdd =() => {
      var namaProduct = this.namaProduct.inputRef.value
      ...
      var deskripsi = this.deskripsi.inputRef.value
            //properti harus sesuai
      // var newData = {
      //     nama : namaProduct,
      //     //kalo namanya sama bisa langsung, gausah pake : lagi.
      //     harga,
      //     discount,
      //     category,
      //     img,
      ...
      Axios.post(urlApi + '/products', {nama : namaProduct, harga, discount, category, img, deskripsi})
      .then((res) => {
  ...
  onBtnSave = () =>{
      ...
      var deskripsi = this.deskripsi.inputRef.value === "" ?  this.state.editItem.deskripsi :  this.deskripsiEdit.inputRef.value
      var newData = {
        nama : namaProduct,
        harga,
        discount,
      ...
      .then((res) => {
        ...
        this.getDataApi()
        swal('Edit Status', 'Edit Success', 'sucess')
        this.setState({isEdit : false, editItem : {}})
      }).catch((err) => {
  ...
  render() {
    ...
    var {nama, harga, discount, category, img, deskripsi, } = this.state.editItem
      ...
      <Paper className='mt-3'>
          <Table>
              ...
              <TableBody>
                  <TableRow>
                      <TableCell>
                        <Input ref={input => this.namaProduct = input} placeholder='Nama Product' className='mt-2 ml-2 mb-2'/>
...
export default connect(mapsStateToProps)(withStyles(styles)(CustomPaginationActionsTable));